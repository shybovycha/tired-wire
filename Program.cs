...
{  
    ...
    {  
        ...
        {  
            endpoints.MapPost("/storeSchema", async context =>  
            {  
            ...
            endpoints.MapPost("/processAvro/{id}", async context =>  
            {  
                ...
                var collection = database.GetCollection<BsonDocument>("avro_collection");  
