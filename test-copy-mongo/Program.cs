...
rootCommand.SetHandler(  
    ...
    {  
        ...
        var sourceDatabase = sourceClient.GetDatabase(new MongoUrlBuilder(sourceDbUrl).DatabaseName);  
        var targetDatabase = targetClient.GetDatabase(new MongoUrlBuilder(targetDbUrl).DatabaseName);  
    ...
    sourceConnectionOption, targetConnectionOption, collectionNameOption  
);  
